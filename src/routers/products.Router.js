...
router.get('/', async (req, res) => {
    ...
    const limit = req.query.limit;
      try {
        ...
        res.json({ error: 'Error al leer el archivo' });
      }
  });
...
router.post('/', async (req, res) => {
    try {
      ...
      const newProduct = {
        ...
        stock,
        category,
        thumbnails: Array.isArray(thumbnail) ? thumbnail : [thumbnail], // Se asigna el array de thumbnails o se crea un array con el valor único
      };
